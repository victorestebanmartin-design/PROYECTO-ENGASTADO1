        ...
        for row in resultados:
            ...
            if clave not in grupos:
                ...
                grupos[clave] = {
                    ...
                    'cables_simple': [],  # AZUL: terminal en un solo lado
                    'num_terminales': 0
                }
            ...
            if cable_marca:
                ...
                elif tiene_origen or tiene_destino:
                    # Esta fila tiene terminal en UN solo lado (AZUL) - 1 terminal
                    grupos[clave]['cables_simple'].append(cable_marca)
